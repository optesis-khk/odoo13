...
class OptesisDads(models.TransientModel):
    ...
    def print_report(self):
        ...
        if self.page == '1':
            return self.env.ref('optesis_payroll_sn.dads_report_1').report_action([], data=datas)
        else:
            return self.env.ref('optesis_payroll_sn.dads_report_2').report_action([], data=datas)
